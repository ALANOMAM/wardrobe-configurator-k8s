...
function LeftSidePanel({ onClick, positionProp, dimensionsPropInMeters }) {
  const gltf = useGLTF("/wardrobe-img/leftPanel.gltf");
  ...
  useEffect(() => {
    ...
    console.log(
      "Left side panel dimensions in meters (W x H x D):",
      scaleX,
      scaleY,
      scaleZ
    );
